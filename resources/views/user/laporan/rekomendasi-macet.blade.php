<html>
    ...
    <center>
        ...
        <br style="line-height:0.6;">
         <b style="font-size: 13px">LEMBAR ANALISA DAN REKOMENDASI PENJAMINAN KREDIT PRODUKTIF</b><br style="line-height:0.6;">     
    </center>
...
<!--             <tr>
    ...
    <br style="line-height:0.6;">
    <b>B. <u> Analisa Usaha </u></b>
  <br style="line-height:0.6;">
        <table>
             <tr>
                <td width="250px">Omset Penjualan</td>
                <td>:</td>
                <td>Rp. </td>
                <td align='right'>{{number_format( $history[0]['omset_penjualan'], 2, ',', '.')}}.</td>
            </tr>
             <tr>
                <td width="150px">Harga Pokok Penjualan</td>
                <td>:</td>
                    <td>Rp. </td>
                 <td align='right'>{{number_format( $history[0]['hpp'], 2, ',', '.')}}.</td>
            </tr>
             <tr>
                <td width="150px">Total Biaya Usaha</td>
                <td>:</td>
                    <td>Rp. </td>
                <td align='right'> {{number_format( $history[0]['biaya_usaha'], 2, ',', '.')}}.</td>
            </tr>
             <tr>
             ...
             <tr>
                <td width="150px"><b>Laba Bersih</b></td>
                <td>:</td>
                 <td>Rp. </td>
     ...
     <br style="line-height:0.6;">
        <table>
            <tr>
                ...
                <td>:</td>
                <td> {{$history[0]['jenis_agunan']}}.</td>
            </tr>
            <tr>
                <td width='150px'>Nilai Pasar</td>
                <td>:</td>  
                <td>Rp. <b>{{number_format( $history[0]['nilai_pasar'], 2, ',', '.')}}.</b></td>
            </tr>  
             <tr>
                <td>Taksasi</td>
                <td>:</td>
                 <td align='right'>Rp. <b>{{number_format( $history[0]['taksiran_taksasi'], 2, ',', '.')}}.</b></td>
            </tr>  
             <tr>
                <td>Kecukupan Agunan</td>
                <td>:</td>
                 <td align='right'><b>{{number_format( $history[0]['nilai_taksasi']/$history[0]['plafon']*100, 2, ',', '.')}}. %</b></td>
            </tr>  
             
        </table>
       <b>D. <u> Rekomendasi </u></b>
     <br style="line-height:0.6;">
        <table>
            <tr>
