...
DAFTAR PENJAMINAN KREDIT {{strtoupper($sertifikat[0]['jeniskredit'])}}</h1>
        <h3>{{strtoupper($sertifikat[0]['namabank'])}}</h3>
        <h3>Nomor : {{strtoupper($sertifikat[0]['kodesertifikat'])}}</h3>
        ...
        <table>
            ...
            <tr>
                <th>Pada Tanggal</th>
                <th>:</th>
                <th>{{date('d-m-Y',strtotime($sertifikat[0]['tglterbit']))}}</th>   
            </tr>
        </table>
        <br>
        <br>
    ...
    <br>
    <img src="data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(100)->generate(md5(base64_encode($sertifikat[0]['nosertifikat'])))) }} ">
