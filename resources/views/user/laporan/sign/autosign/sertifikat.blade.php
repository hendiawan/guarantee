<html>
    ...
    <?php
       ...
       if ($sertifikat[0]['nama_perubahan'])
            {$nama_bank=$sertifikat[0]['nama_perubahan'];}
       else
            {$nama_bank=$sertifikat[0]['namabank'];}
    ...
    <center>
        ...
        <p align="justify" >Dengan ini   <b>PT.JAMKRIDA NTB BERSAING</b> dengan alamat di Ruko Bung Karno Jaya No.11, Jl. Bung Karno (Sayung), Cilinaya,
            ...
            yaitu <b>{{strtoupper($nama_bank)}} </b>dengan alamat di {{ucwords(strtolower($sertifikat[0]['alamatbank']))}}.
            ...
            <tr align="left" valign="top">
               <td width="45%" height="180px">
                    <div class="relative">
                        ...
                        <div class="signed-image" >
                           <img   style="margin-left:-20px"   src= "data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(160)->merge('img/jamkrida.png', 0.35, true)->generate('https://jamkridantb.com/verifikasi-doc-sertifikat-penjaminan/'.md5(base64_encode($sertifikat[0]['nosertifikat']))))}} ">
<!--                            <br> --> 
     ...
     <table width="100%" cellpadding="0" cellspacing="0">
            <tr align="left" valign="top">
                      ...
                      @if ($sertifikat[0]['digitalSign']==1) 
                       ...
                       @else
                       <td width="45%" style="text-transform:uppercase">
                           <span style="font-weight:bold;border-bottom:1px solid #000;padding:0 4px;"> {{$userttd['usr_ttd']}}</span>
                        </td>  
                       @endif 
            </tr>
            <tr>
                  ...
                  @if ($sertifikat[0]['digitalSign']==1) 
                    ...
                    @else
                       <td>
                          <span style="border-bottom:0px solid #000;padding:0 4px;">  {{$userttd['jabatan']}}</span>
                       </td> 
                    @endif  
            </tr>
        </table>
