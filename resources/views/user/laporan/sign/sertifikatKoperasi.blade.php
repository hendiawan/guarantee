     ...
     <table width="100%" cellpadding="0" cellspacing="0">
            <tr align="left" valign="top"> 
                      @if ($sertifikat[0]['digitalSign']==1) 
                       ...
                       @else
                       <td width="45%" style="text-transform:uppercase">
                           <span style="font-weight:bold;border-bottom:1px solid #000;padding:0 4px;"> {{Auth::user()->name}}</span>
                        </td>  
                       @endif 
            </tr>
            <tr>
                  ...
                  @if ($sertifikat[0]['digitalSign']==1) 
                    ...
                    @else
                       <td>
                          <span style="border-bottom:0px solid #000;padding:0 4px;">  {{Auth::user()->jabatan}}</span>
                       </td> 
                    @endif  
            </tr>
        </table>
