 ...
 <br style="line-height:0.3;">
      ...
      <br style="line-height:0.2;">
        <p>
           ...
           Pihak Penjamin dengan Pihak Penerima Jaminan Nomor :<b> {{$sertifikat[0]['pks']}}</b>  Tanggal: <b>{{tgl_indo(date('d-m-Y',strtotime($sertifikat[0]['tglPks'])))}}</b> 
        </p>
<!--        <br>-->
 <br style="line-height:0.4;">
        <p>
           Jangka waktu berlakunya Sertifikat Penjaminan ini sama dengan jangka waktu berlakunya perjanjian
           pinjaman; yaitu terhitung sejak tanggal {{tgl_indo(date('d-m-Y',strtotime($sertifikat[0]['tglrealisasi'])))}} sampai dengan tanggal {{tgl_indo(date('d-m-Y',strtotime($sertifikat[0]['tgljatuhtempo'])))}}; dengan
...
<!--        <br>-->
 <br style="line-height:0.4;">
        ...
        <p>
            ...
            diajukan oleh Penerima Jaminan Nomor : {{$sertifikat[0]['nosertifikat']}}  tanggal  {{tgl_indo(date('d-m-Y',strtotime($sertifikat[0]['tglpengajuan'])))}}.
        </p>
<!--        <br>-->
 <br style="line-height:0.4;">
