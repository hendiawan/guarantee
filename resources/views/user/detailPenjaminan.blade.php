...
@section('content') 
<body>
    <form action="/pengajuan-ulang"  method="post" id="validation_form">
        <div class="container">  
            ...
            <div class="panel panel-default" style="border-radius: 15px"   >
                ...
                <div style="margin: 10px" class="panel-body">
                         <div  class="box-body"> 
                            ...
                            @if($penjaminan->jeniskredit=="KONSUMTIF")
                            <div class="form-group">
            ...
            <div class="panel panel-default" style="border-radius: 15px"   >
                ...
                <div style="margin:10px" class="panel-body">
                       ...
                       <div class="form-group">
                               ...
                               <style>
                                ...
                                <table class="ftable">
                                        <tr class="{{$showDocSehat}}">  
                                            ...
                                            <td><a style="color:black; border-radius:6px; border-color: #cccccc"  class="btn" target="_BLANK"  href="@if($penjaminan->url_penjaminan!=null)<?php echo '/'. $penjaminan -> url_penjaminan?>@else files/suratsehat/{{$penjaminan ->files}} @endif"> <i class="glyphicon glyphicon-save"></i></a></td>
                                       ...
                                       <tr class="{{$showDocAnalisa}}"> 
                                        ...
                                        <tr> 
                                          ...
                                          <tr class="{{$showbuktibayar}}">
                                            ...
                                            <!--<td align="right"><a style="color:black; border-radius:6px; border-color: #cccccc"  class="btn" target="_BLANK"  href="@if($penjaminan->url_penjaminan!=null)<?php echo '/'.  $penjaminan -> url_penjaminan.$penjaminan ->file?>@else  /files/buktibayar/{{$penjaminan->file}}  @endif"><i class="glyphicon glyphicon-save"></i></a></td>--> 
                        ...
                        <br>  
                        @if($penjaminan->statusbayar==1)
                                        @if($penjaminan->catatanPembayaran)
                                            <div class="form-group">
                                                    <p><b>Catatan </b></p>
                                                    <textarea readonly="" style="resize:none;width:100%;height:80px;"  name="catatanPembayaran" id="catatanPembayaran" class="form-control">{{old('catatanPembayaran',$penjaminan->catatan_pembayaran)}}</textarea>  
                                        ...
                                        <div class="form-group">
                                            <p><b>Catatan </b></p>
                                            <textarea readonly="" style="resize:none;width:100%;height:80px;"  name="catatan" id="catatan" class="form-control">{{old('catatan',$penjaminan->catatan)}}</textarea>  
                        ...
                        @else
                                     <div class="form-group">
                                                <p><b>Catatan </b></p>
                                                <textarea readonly="" style="resize:none;width:100%;height:300px;"  name="catatan" id="catatan" class="form-control">{{old('catatan',$penjaminan->catatan)}}</textarea>  
                                                   @if($errors->has('catatan'))
                                                  <p style="color: red"> {{ $errors-> first('catatan')}}</p>
                                                  @endif
                                        </div>
                        @endif 
                         ...
                         <div class="form-group">
                                    <p><b>Tanggapan </b></p>
                                    <textarea  style="resize:none;width:100%;height:80px;"  name="tanggapan" id="tanggapan" class="form-control">{{old('tanggapan',$penjaminan->tanggapan)}}</textarea>  
                                       @if($errors->has('tanggapan'))
                                      <p style="color: red"> {{ $errors-> first('tanggapan')}}</p>
                                      @endif
                            </div>
