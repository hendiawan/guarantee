...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">             
            <div class="box-body col-sm-12">
                <div class="box-body">
                    <form method="POST"  action="{{url('pembayaranauto')}}"  id="formPembayaran" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-group">

                            <div class="form-group">
                                <label>KODE PEMBAYARAN</label>
                                <input   value="pembayaranSingle"      name="jenisPembayaran"  type="text"  hidden="">
                                <input   value="{{$datas -> idpenjaminan}}"      name="idpenjaminan"  type="text"  hidden="">
                                <input   value="<?php echo session::get('idbank') . date('YmdHis') . $kode + 1 ?>"      name="kodepembayaran"  type="text"  hidden="">
                                <input   disabled="" required="" value="<?php echo session::get('idbank') .date('YmdHis') . $kode + 1 ?>"  type="text" class="form-control" >
                            </div>                                
