...
<body>
    ...
    <div class="container">
        ...
        <section  class="col-lg-12" >
         ...
         <form action="/simpanPenjaminanKonsumtif" method="post"  id="formPenjaminan"  enctype="multipart/form-data" >
                         ...
                         <div  class="box-body">  
                            ...
                            <div class="form-group">
                                ...
                                <div class="icheck-greensea icheck-inline">
                                    <input checked="" {{ old('jenis_pekerjaan')=='KARYAWAN' ? "checked" : "" }}   value="KARYAWAN" name="jenis_pekerjaan" required="" type="radio" id="radio-karyawan" />
                                    <label for="radio-karyawan">Karyawan</label> 
                                </div>
                                <div class="icheck-greensea icheck-inline">
                                    <input disabled="" {{ old('jenis_pekerjaan')=='PENGUSAHA' ? "checked" : "" }}  value="PENGUSAHA" name="jenis_pekerjaan" required="" type="radio" id="radio-pengusaha" />
                                    <label for="radio-pengusaha">Pengusaha</label> 
                                </div>
                            </div>
                            <div class="form-group">
                                <p id="namaPerusahaan">Nama Perusahaan / Instansi<b style="color: red"> * </b></p>
                                <input placeholder="Contoh : Bank NTB Syariah, Dinas Penanaman Modal, dll" value="{{old('namaPerusahaan')}}" required="" minlength="3" class="form-control" name="namaPerusahaan" id="namaPerusahaan">
                                @if($errors->has('namaPerusahaan'))
                                <p style="color: red"> {{ $errors->first('namaPerusahaan')}}</p>
                                @endif
                            </div>
                            <div class="form-group hidden">
                                <p >Pekerjaan <b style="color: red"> * </b></p>
                                <input placeholder="" value="KARYAWAN" required="" minlength="3" class="form-control" name="pekerjaan" id="pekerjaan">
                               </div>
                            <div class="form-group">
                                <p >Jabatan<b style="color: red"> * </b></p>
                                <input placeholder="Menjelaskan jabatan pada perusahaan/instansi" value="{{old('jabatan')}}" required="" minlength="3" class="form-control" name="jabatan" id="jabatan">
                                @if($errors->has('jabatan'))
                                <p style="color: red"> {{ $errors->first('jabatan')}}</p>
                                @endif
                            </div>
                            <div class="form-group">
                                <p >Lama Bekerja<b style="color: red"> * </b></p>
                                <input placeholder="Menjelaskan masa kerja terjamin pada perusahaan" value="{{old('masaKerja')}}" required="" minlength="3" class="form-control" name="masaKerja" id="masaKerja">
                                @if($errors->has('masaKerja'))
                                <p style="color: red"> {{ $errors->first('masaKerja')}}</p>
                                @endif
                            </div>
            ...
            <div class="panel panel-default" style="border-radius: 15px"   >
                ...
                <div style="margin:10px" class="panel-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="icheck-greensea icheck-inline">
                               <input checked="" {{ old('kredit')=='KONSUMTIF' ? "checked" : "" }}   value="KONSUMTIF" name="kredit" required="" type="radio" id="radio-konsumtif" />
                               <label for="radio-konsumtif">Multiguna</label> 
                           </div>
                           <div class="icheck-greensea icheck-inline">
                               <input disabled="" {{ old('kredit')=='PRODUKTIF' ? "checked" : "" }}  value="PRODUKTIF" name="kredit" required="" type="radio" id="radio-produktif" />
...
<!--                                    <td> 
                        ...
                        @endif
                           ...
                           <div class="icheck-danger icheck-inline">
                               <input class="detailSkimKredit"  {{ old('detailSkim')=='PHK' ? "checked" : "" }}  value="PHK" name="detailSkim" required="" type="radio" id="radio-phk" />
                               <label for="radio-phk">PHK</label> 
                           </div>
                       </div>
...
<!--                        <div class="form-group">
                           ...
                           <input value="{{old('nilai_taksasi')}}" required=""  onkeyup="FormatCurrency(this)"  minlength="3" class="form-control" name="nilai_taksasi" id="nilai_taksasi">
                           @if($errors->has('penggunaan'))
                          ...
                          <p>Lampiran Berkas Penjaminan</p>  
                            <div style="margin: 15px">
                                <div   class="form-group hidden " id="suratPernyataanSehat">
                                    ...
                                    <input onchange="ValidateFileUpload(this)" name="fileSuratSehat" id="fileSuratSehat"type="file" class="form-control"><br/>
                                ...
                                <div class="form-group hidden" id="cekGetaranJantung">                             
                                 ...
                                 <div class="form-group hidden" id="cekDocSk">                             
                                    <label>Upload  Doc SK Pengangkatan|PDF|JPG|Max. 700Kb<b style="color: red">( * )</b></label>
                                    <input onchange="ValidateFileUpload(this)" name="cekDocSk" id="fileSk"  type="file" class="form-control"><br/>
                             
                                    @if($errors->has('cekDocSk'))
                                    <p style="color: red"> {{ $errors->first('cekDocSk')}}</p> 
                                    @endif
                                    <div id="ProgressSK" hidden="" class="progress">
                                        <div id="bar_Sk" class="bar"></div >
                                        <div id="percent_Sk" class="percent">0%</div >
                                    </div> 
                                </div>
