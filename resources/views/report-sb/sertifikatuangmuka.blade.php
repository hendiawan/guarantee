...
<html lang="en">
	...
	<table width="100%" cellpadding="0" cellspacing="0" style="color:#FF8989;">
                            ...
                            <div style="height:8px">
                                <h3 align="center" style="font-size:20px;"><strong>JAMINAN UANG MUKA</strong></h3>
...
<!--                            <br>
                            ...
                            <ol class="sertifikat-list">
                                ...
                                <li class="text-justify">Maka kami, <strong>TERJAMIN</strong> dan <strong>PENJAMIN</strong> dengan ini mengikatkan diri 
                                    ...
                                    memenuhi kewajibannya dalam melaksanakan pekerjaan <strong>{{ $sppsb->jenis_pekerjaan }}</strong> yang telah dipercayakan kepadanya atas dasar <strong>{{ $sppsb->nama_dokumen }}</strong> dari
                                    <strong>PENERIMA JAMINAN</strong> Nomor : <strong>{{ $sppsb->no_dokumen }}</strong> tanggal {{ $direksi->tgl_indo($sppsb->tgl_dokumen) }}.
                                </li>
                                ...
                                <li class="text-justify">Jaminan ini berlaku apabila <strong>TERJAMIN</strong> tidak memenuhi kewajibannya melakukan pembayaran kembali kepada
                                    <strong>PENERIMA JAMINAN</strong> senilai uang muka yang wajib dibayar menurut dokumen Kontrak.
                                </li>
                                <li class="text-justify"><strong>PENJAMIN</strong> akan membayar kepada <strong>PENERIMA JAMINAN</strong> maksimal sejumlah nilai jaminan tersebut di atas dalam
