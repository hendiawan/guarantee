...
<!--                            <br>
                          ...
                          <ol class="sertifikat-list"> 
                                <li class="text-justify">Dengan ini dinyatakan bahwa kami <span class="text-uppercase"><strong>{{ $sppsb->nama_kontraktor }}</strong></span>
                                    ...
                                    <strong>PT. JAMKRIDA NTB BERSAING Jalan Catur Warga Nomor 5, Mataram, NTB</strong> sebagai <strong>PENJAMIN</strong>, selanjutnya disebut 
                                    <strong>PENJAMIN</strong>, bertanggung jawab dan dengan tegas terikat pada <span class="text-uppercase"><strong>{{ $sppsb->pemilik_proyek }}, {{ $sppsb->alamat }}</strong></span> 
                                    sebagai <strong>PELAKSANA TENDER  {{ $sppsb->jenis_pekerjaan}} </strong>, selanjutnya disebut sebagai <strong>PENERIMA JAMINAN</strong> atas
                                    uang sejumlah Rp. {{ $nilaiJaminanFormat}} ({{ $nilaiJaminan }} Rupiah ).
                                </li> 
                                <li class="text-justify">Maka kami, TERJAMIN dan PENJAMIN dengan ini mengikatkan diri untuk  melakukan pembayaran jumlah tersebut di atas dengan baik dan benar bilamana
                                    <strong>TERJAMIN</strong> tidak memenuhi ketentuan yaitu:
                                    <ol type="a">
                                        <li>Terlibat Korupsi, Kolusi dan/ atau Nepotisme.</li>
                                        <li>Menarik kembali penawarannya selama dilaksanakannya tender;</li>
                                        <li>Tidak Bersedia menambah nilai jaminan pelaksanaan dalam hal sebagai calon pemenang cadangan
                                            1 dan 2 harga penawarannya di bawah 80% HPS;
                                        </li>                                                
                                        <li>
                                            Tidak  hadir dalam klarifikasi dan/atau verifikasi kualifikasi dalam hal sebagai calon pemenang dan calon pemenang 1 dan 2 dengan alasan tidak dapat diterima; atau
                                        </li> 
                                        <li>Mengundurkan diri atau gagal tanda tangan kontrak</li>
                                    </ol>
                                </li>
                                <li class="text-justify">Surat jaminan ini berlaku selama {{ $sppsb->durasi }} ({{$selisih}} ) hari kalender dan efektif mulai tanggal {{ $direksi->tgl_indo($sppsb->waktu_mulai) }}.							
                                </li>
                                <li class="text-justify"><strong>PENJAMIN</strong> akan membayar kepada <strong>PENERIMA JAMINAN</strong> sejumlah nilai jaminan tersebut di atas dalam waktu paling lambat 14 ( Empat Belas ) hari kerja <strong>tanpa syarat (unconditional)</strong> setelah menerima tuntutan penagihan secara tertulis dari <strong>PENERIMA JAMINAN</strong> berdasarkan keputusan <strong>PENERIMA JAMINAN</strong> mengenai pengenaan sanksi akibat <strong>TERJAMIN</strong> cidera janji/wan prestasi.
                                </li>
                                <li class="text-justify">Menunjuk pasal 1832 KUH Perdata, dengan ini ditegaskan kembali bahwa <strong>PENJAMIN</strong> melepaskan hak-hak istimewanya untuk menuntut supaya harta benda <strong>TERJAMIN</strong> lebih dahulu disita dan dijual guna melunasi hutang-hutangnya sebagaimana dimaksud dalam pasal 1831 KUH Perdata.
                                </li>
                                <li class="text-justify">Tuntutan pencairan terhadap <strong>TERJAMIN</strong> berdasarkan jaminan ini harus sudah diajukan selambat-lambatnya dalam waktu 30 ( Tiga Puluh ) hari kalender sesudah berakhirnya masa laku jaminan ini.
                                </li>
                            </ol>
                            <p style="padding-top:0; padding-left:5px;line-height:0.09px;">Dikeluarkan di Mataram pada tanggal {{ $direksi->tgl_indo($sppsb->tgl_cetak) }}</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
