                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <div style="height:8px">
                                <h3 align="center" style="font-size:20px;"><strong>JAMINAN PEMBAYARAN</strong></h3>
                            ...
                            <ol class="sertifikat-list">
                                ...
                                <li class="text-justify">Maka kami, <strong>TERJAMIN</strong> dan <strong>PENJAMIN</strong> dengan ini mengikatkan diri 
                                    ...
                                    memenuhi kewajibannya dalam melaksanakan <strong>PEKERJAAN : {{ $sppsb->jenis_pekerjaan }}</strong> yang dilakukan atas dasar <strong>{{ $sppsb->nama_dokumen }}</strong> dari
                                ...
                                <li class="text-justify">Jaminan ini berlaku apabila <strong>TERJAMIN</strong> tidak memenuhi kewajibannya melakukan penyelesaian pekerjaan
                                    yang dilakukannya berdasarkan dokumen Kontrak.
                                </li>
