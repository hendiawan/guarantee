                       ...
                       <div class="form-group">
                        ...
                        <br>  
                         ...
                         <div class="form-group">
                              ...
                              <input onchange="HitungPendapatanBersih()" onkeyup="FormatCurrency(this)"  placeholder="100.000.000,-"  value="{{old('angsuran',format_number($penjaminan->angsuran))}}"  id="angsuran" name="angsuran" class="form-control">
                        ...
                        <div class="form-group">
                               ...
                               <input onchange="HitungPendapatanBersih()"  placeholder="100.000.000,-"  value="{{old('pendaptanPemohon',format_number($penjaminan->pendapatan_utama))}}"  onkeyup="FormatCurrency(this)"  id="pendapatanPemohon" name="pendapatanPemohon" class="form-control"> 
                   
                               @if($errors->has('pendapatanPemohon'))
                                  <p style="color: red"> {{ $errors-> first('pendapatanPemohon')}}</p>
                                  @endif
                               <p>Pendapatan Lainnya</p>
                               <input onchange="HitungPendapatanBersih()"  placeholder="100.000.000,-"  value="{{old('pendapatanLainnya',format_number($penjaminan->pendaptan_lainnya))}}"  onkeyup="FormatCurrency(this)"  id="pendapatanLainnya" name="pendapatanLainnya" class="form-control"> 
                               @if($errors->has('pendapatanPemohon'))
                                  <p style="color: red"> {{ $errors-> first('pendapatanPemohon')}}</p>
                                @endif 
                                 <p><b>Pengeluaran</b></p>
                               ...
                               <p>Total Biaya Rumah Tangga</p>
                                 <input onchange="HitungPendapatanBersih()"  placeholder="100.000.000,-"   value="{{old('biayaRumahTangga',format_number($penjaminan->biaya_rumah_tangga))}}" onkeyup="FormatCurrency(this)"   id="biayaRumahTangga" name="biayaRumahTangga" class="form-control">
                                 @if($errors->has('biayaRumahTangga'))
                                  <p style="color: red"> {{ $errors-> first('biayaRumahTangga')}}</p>
                                  @endif 
                                 <p>Angsuran Kredit di Tempat Lain</p>
                                 <input onchange="HitungPendapatanBersih()"  placeholder="100.000.000,-"  onkeyup="FormatCurrency(this)"  value="{{old('angsuranKreditTempatLain',format_number($penjaminan->angsuran_lainnya))}}"    id="angsuranKreditTempatLain" name="angsuranKreditTempatLain" class="form-control">
                                   @if($errors->has('angsuranKreditTempatLain'))
                                  <p style="color: red"> {{ $errors-> first('angsuranKreditTempatLain')}}</p>
                                  @endif
                                     <p>Pendapatan Bersih </p>
                                  <input  readonly="" style="color: #9b59b6" value="{{old('labaBersih',format_number($penjaminan->pendapatan_bersih))}}"    id="pendapatanBersih" name="pendapatanBersih" class="form-control">
                           ...
                           <div class="form-group">
                                ...
                                <textarea required="" style="resize:none;width:100%;height:100px;"  name="analisaKesehatan" id="analisaKesehatan" class="form-control">{{old('analisaKesehatan',$penjaminan->analisa_kesehatan)}}</textarea>  
