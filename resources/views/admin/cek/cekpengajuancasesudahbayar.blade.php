...
<div class="panel panel-default">
    <div class="panel-heading">
        <strong>
            ...
            <h2 align="center" style="color: red ">CASE BY CASE</h2>
                        ...
                        <tbody>
                           ...
                           ?>
                            <tr style="background-color:#bdbdbd ;color: #000000">  
                                ...
                                <td>
                                    <!--<a id="{{$data ->idpenjaminan}}" class="btn btn-xs btn-primary validasicaseBelumBayar">Cek Pembayaran</a>-->
                ...
                <div class="modal-body">
                    ...
                    <table>                        
                        ...
                        <tr> 
                            ...
                            <th>
                                <input style="text-align: right" disabled="" id="nett" class="form-control">
                            </th>  
                        </tr>
                        <tr> 
                            <th>
                        ...
                        <tr> 
                            ...
                            <th>
                                ...
                                <input id="validasibayar" class="radio bayar" type="radio" name="pembayaran" value="Ok" /> 
                                     <label for="validasibayar">SESUAI</label>
                                </div> 
                            </th>
                            <th>
                                <div class="radio icheck-danger">
                                <input id="validasibayar1" class="radio bayar" type="radio" name="pembayaran" value="Tolak" /> 
                                     <label for="validasibayar1">TIDAK</label>
                                </div> 
                            </th>
                    ...
                    <th>
                        <textarea style="resize:none;width:100%;height:300px;" name="analisa" id="analisa" class="form-control">
