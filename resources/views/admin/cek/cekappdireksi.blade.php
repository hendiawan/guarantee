...
<body ng-app="Penjaminan" ng-controller="PenjaminanController">
    ...
    <div class="panel-heading">
        <strong>
        <h2 align="center">DATA PENGAJUAN PENJAMINAN KREDIT CASE BY CASE</h2>
        <h2 style="color: red" align="center">BELUM DI APPROV DIREKSI</h2>
        </strong>
    </div>
...
<!--                                <td>{{date('d-m-Y', strtotime($data -> tglrealisasi))}}</td>
                                ...
                                <td>
                                    <!--<a id="{{$data->nosertifikat}}" class="btn btn-xs btn-primary klickvalidasidireksi">DETAIL</a>--> 
