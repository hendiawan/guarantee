                ...
                <div style="margin:10px" class="panel-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                               ...
                               <input  readonly="" onchange="HitungPendapatanBersih()"   placeholder="100.000.000,-"  value="{{old('pendaptanPemohon',format_number($penjaminan->pendapatan_utama))}}"  onkeyup="FormatCurrency(this)"  id="pendapatanPemohon" name="pendapatanPemohon" class="form-control"> 
                   
                               @if($errors->has('pendapatanPemohon'))
                                  <p style="color: red"> {{ $errors-> first('pendapatanPemohon')}}</p>
                                  @endif
                               <p>Pendapatan Lainnya</p>
                               <input readonly="" onchange="HitungPendapatanBersih()"   placeholder="100.000.000,-"  value="{{old('pendapatanLainnya',format_number($penjaminan->pendapatan_lainnya))}}"  onkeyup="FormatCurrency(this)"  id="pendapatanLainnya" name="pendapatanLainnya" class="form-control"> 
                               @if($errors->has('pendapatanPemohon'))
                                  <p style="color: red"> {{ $errors-> first('pendapatanPemohon')}}</p>
                                @endif 
                                 <p><b>Pengeluaran</b></p>
                               ...
                               <input readonly="" onchange="HitungPendapatanBersih()"  placeholder="100.000.000,-"   value="{{old('biayaRumahTangga',format_number($penjaminan->biaya_rumah_tangga))}}" onkeyup="FormatCurrency(this)"   id="biayaRumahTangga" name="biayaRumahTangga" class="form-control">
                                 @if($errors->has('biayaRumahTangga'))
                                  <p style="color: red"> {{ $errors-> first('biayaRumahTangga')}}</p>
                                  @endif 
                                 <p>Angsuran Kredit di Tempat Lain</p>
                                 <input readonly="" onchange="HitungPendapatanBersih()"   placeholder="100.000.000,-"  onkeyup="FormatCurrency(this)"  value="{{old('angsuranKreditTempatLain',format_number($penjaminan->angsuran_lainnya))}}"    id="angsuranKreditTempatLain" name="angsuranKreditTempatLain" class="form-control">
                                   @if($errors->has('angsuranKreditTempatLain'))
                                  <p style="color: red"> {{ $errors-> first('angsuranKreditTempatLain')}}</p>
                                  @endif
                                  <p>Pendapatan Bersih  <b id="labaRugi"></b></p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio icheck-primary">
                                    <input readonly=""   @if($penjaminan->kapasitas=="memenuhi") checked="" @endif    {{old('kapasitas')=='memenuhi' ? 'checked=""' : "" }}   placeholder="100.000.000,-"    id="memenuhi" class="radio" type="radio" name="kapasitas" value="memenuhi" /> 
                                    <label  for="memenuhi">Memenuhi</label>
                                </div>
                                <div class="radio icheck-primary">
                                    <input readonly="" @if($penjaminan->kapasitas=="tidakMemenuhi") checked="" @endif  {{old('kapasitas')=='tidakMemenuhi' ? 'checked=""' : "" }}    id="tidakMemenuhi" class="radio" type="radio" name="kapasitas" value="tidakMemenuhi" /> 
                         ...
                         @endif
                           ...
                           <div class="form-group">
                                ...
                                <textarea  required="" style="resize:true;height:80px;" value="" name="rekomendasiKabag" id="analisaKabag" class="form-control">{{old('rekomendasiKabag',$penjaminan->rekomendasi_kabag)}}</textarea>
                              ...
                              @if($penjaminan->statusbayar==1)
                                        <div class="form-group">
                                                ...
                                                <textarea style="resize:none;width:100%;height:80px;"  name="catatanPembayaran" id="catatanPembayaran" class="form-control">{{old('catatanPembayaran',$penjaminan->catatan_pembayaran)}}</textarea>  
