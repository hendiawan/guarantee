                ...
                <div style="margin:10px" class="panel-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                              ...
                              <textarea readonly="" style="resize:none;width:100%;height:300px;"  name="analisa" id="analisa" class="form-control">{{$penjaminan->analisa_pekerjaan}}</textarea>  
                        ...
                        <div class="form-group">
                              <p>Analisa Umur dan Fasilitas Kredit<b style="color: red"> * </b></p> 
                               <textarea readonly="" style="resize:none;width:100%;height:300px;"  name="analisaUmur" id="analisaUmur" class="form-control">{{$penjaminan->analisa_umur}}</textarea>  
                        ...
                        <div class="form-group">
                                <p><b>DATA KESEHATAN</b></p>
                                <textarea readonly="" style="resize:none;width:100%;height:300px;"  name="analisaKesehatan" id="analisaKesehatan" class="form-control">{{old('analisaKesehatan',$penjaminan->analisa_kesehatan)}}</textarea>  
