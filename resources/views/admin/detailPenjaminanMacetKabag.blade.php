                ...
                <div style="margin:10px" class="panel-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                               ...
                               <hr>
                               <p>Omset Penjualan</p>
                               <input  readonly=""  placeholder="100.000.000,-"  value="{{old('omsetPenjualan',format_number($penjaminan->omset_penjualan))}}"  onkeyup="FormatCurrency(this)"  id="omsetPenjualan" name="omsetPenjualan" class="form-control"> 
                               ...
                               <hr>
                                ...
                                <input  readonly=""  placeholder="100.000.000,-"  value="{{old('hpp',format_number($penjaminan->hpp))}}"  id="hpp" name="hpp" onkeyup="FormatCurrency(this)"  class="form-control">
                                   @if($errors->has('hpp'))
                                 ...
                                 <input  readonly=""   placeholder="100.000.000,-" value="{{old('biayaUsaha',format_number($penjaminan->biaya_usaha))}}"  id="biayaUsaha" onkeyup="FormatCurrency(this)"  name="biayaUsaha" class="form-control">
                        ...
                        <div class="form-group"> 
                          ...
                          <div class="form-group">
                               <p>Nilai Pasar</p>
                                 <input readonly=""   placeholder="100.000.000,-"  onkeyup="FormatCurrency(this)"  value="{{old('nilaiPasar',format_number($penjaminan->nilai_pasar))}}"    id="nilaiPasar" name="nilaiPasar" class="form-control">
                                   @if($errors->has('nilaiPasar'))
                                  <p style="color: red"> {{ $errors-> first('nilaiPasar')}}</p>
                                  @endif
                           </div>
                          <div class="form-group hidden">
                               <p>Nilai Taksasi dari Bank</p>
                               <input readonly=""  readonly="" value="{{old('nilaiTaksasi',number_format($penjaminan->nilai_taksasi,0,'.',','))}}"    id="nilaiTaksasi" name="nilaiTaksasi" class="form-control">
                                   @if($errors->has('nilaiTaksasi'))
                                  <p style="color: red"> {{ $errors-> first('nilaiTaksasi')}}</p>
                                  @endif
                           </div>
                             <div class="form-group">
                               <p>Taksiran Taksasi Staf</p>
                               <input readonly="" onkeyup="FormatCurrency(this)"  value="{{old('taksiran_taksasi',number_format($penjaminan->taksiran_taksasi,0,'.',','))}}"    id="taksiran_taksasi" name="taksiran_taksasi" class="form-control">
