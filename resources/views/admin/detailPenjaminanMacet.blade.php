...
<body>
    <form action="/post/validasi/produktif"  method="post" id="validation_form">
        <div class="container"> 
            ...
            <div class="panel panel-default" style="border-radius: 15px"   >
                ...
                <div style="margin: 10px" class="panel-body">
                         <div  class="box-body"> 
                            ...
                            <div class="form-group">
                                <p id="detailPekerjaan">Lama Usaha Berjalan<b style="color: red"> * </b></p>
                                <input  readonly=""  value="{{$penjaminan->lama_usaha}}" required="" minlength="3" class="form-control" name="lama_usaha" id="lama_usaha">
                            </div> 
                            <div class="form-group ">  
                       ...
                       <div class="form-group">
                            ...
                            <div style="margin: 15px">
                               <style>
                                    ...
                                    @php
                                             ...
                                             if ($penjaminan ->doc_taksasi=='No'){ $showDocTaksasi= "hide" ; }else {if($penjaminan ->doc_taksasi!=""){$showDocTaksasi = "" ;}{$showDocTaksasi = "hide" ;}}
                        ...
                        <br>  
                         ...
                         <div class="form-group">
                              ...
                              <input type="number" placeholder="1%"  value="{{old('sukuBunga',$penjaminan->suku_bunga)}}"  id="sukuBunga" name="sukuBunga" class="form-control">
                         ...
                         <div class="form-group">
                              ...
                              <input onchange="HitungLabaBersih()" onkeyup="FormatCurrency(this)"   placeholder="100.000.000,-"  value="{{old('angsuran',format_number($penjaminan->angsuran))}}"  id="angsuran" name="angsuran" class="form-control">
                         ...
                         <div class="form-group">
                            ...
                            <select name="pengecekanSlik" required="" class="form-control">
                               ...
                               <p><b>ANALISA USAHA</b></p>  
                               <p><b>Pendapatan</b></p>
                               <hr>
                               <div class="form-group">
                                        <p>Omset Penjualan</p>
                                       <input onchange="HitungLabaBersih()"  placeholder="100.000.000,-"  value="{{old('omsetPenjualan',format_number($penjaminan->omset_penjualan))}}"  onkeyup="FormatCurrency(this)"  id="omsetPenjualan" name="omsetPenjualan" class="form-control"> 
                                           @if($errors->has('omsetPenjualan'))
                                          <p style="color: red"> {{ $errors-> first('omsetPenjualan')}}</p>
                                          @endif
                               </div> 
                               <p><b>Pengeluaran</b></p>
                               <hr>
                               <div class="form-group">
                                    ...
                                    <input onchange="HitungLabaBersih()"  placeholder="100.000.000,-"  value="{{old('hpp',format_number($penjaminan->hpp))}}"  id="hpp" name="hpp" onkeyup="FormatCurrency(this)"  class="form-control">
                                       @if($errors->has('hpp'))
                                      <p style="color: red"> {{ $errors-> first('hpp')}}</p>
                                      @endif 
                               </div>
                               <div class="form-group">
                                   <p>Total Biaya Rumah Tangga</p>
                                 <input onchange="HitungLabaBersih()" placeholder="100.000.000,-"   value="{{old('biayaRumahTangga',format_number($penjaminan->biaya_rumah_tangga))}}" onkeyup="FormatCurrency(this)"   id="biayaRumahTangga" name="biayaRumahTangga" class="form-control">
                                 @if($errors->has('biayaRumahTangga'))
                                  <p style="color: red"> {{ $errors-> first('biayaRumahTangga')}}</p>
                                  @endif
                               </div>
                               <div class="form-group">
                                    <p>Total Biaya Usaha</p>
                                 <input  onchange="HitungLabaBersih()"  placeholder="100.000.000,-" value="{{old('biayaUsaha',format_number($penjaminan->biaya_usaha))}}"  id="biayaUsaha" onkeyup="FormatCurrency(this)"  name="biayaUsaha" class="form-control">
                                 @if($errors->has('biayaUsaha'))
                                  <p style="color: red"> {{ $errors-> first('biayaUsaha')}}</p>
                                  @endif
                               </div>
                               <div class="form-group">
                                    <p>Angsuran Kredit di Tempat Lain</p>
                                 <input onchange="HitungLabaBersih()"  placeholder="100.000.000,-"  onkeyup="FormatCurrency(this)"  value="{{old('angsuranKreditTempatLain',format_number($penjaminan->angsuran_lainnya))}}"    id="angsuranKreditTempatLain" name="angsuranKreditTempatLain" class="form-control">
                          ...
                          <div class="form-group">
                                  <p>Laba Bersih  <b id="labaRugi"></b></p>
                                  <input  readonly="" style="color: #9b59b6" placeholder="100.000.000,-" value="{{old('labaBersih',format_number($penjaminan->pendapatan_bersih))}}"    id="labaBersih" name="labaBersih" class="form-control">
                       </div>   
                        <div class="form-group"> 
                          <p>Jenis Dokumen Agunan<b style="color: red"> * </b></p> 
                          <select name="jenisAgunan" required="" class="form-control">
                                <option value="">Silihkan Pilih Jenis Dokumen</option>
                                <option  @if($penjaminan->jenis_agunan=="shm") selected="" @endif    @if(old('jenisAgunan')=='shm') selected="" @endif  value="shm">SHM</option>
                                <option  @if($penjaminan->jenis_agunan=="shgb") selected="" @endif  @if(old('jenisAgunan')=='shgb') selected="" @endif value="shgb">SHGB</option>
                                <option  @if($penjaminan->jenis_agunan=="bpkb") selected="" @endif  @if(old('jenisAgunan')=='bpkb') selected="" @endif value="bpkb">BPKB</option>
                                <option  @if($penjaminan->jenis_agunan=="deposito") selected="" @endif @if(old('jenisAgunan')=='deposito') selected="" @endif  value="deposito">Bilyet Deposito</option> 
                            </select>
                              @if($errors->has('jenisAgunan'))
                                  <p style="color: red"> {{ $errors-> first('jenisAgunan')}}</p>
                                  @endif
                        </div>  
                          <div class="form-group">
                               <p>Nilai Pasar</p>
                                 <input  placeholder="100.000.000,-"  onkeyup="FormatCurrency(this)"  value="{{old('nilaiPasar',format_number($penjaminan->nilai_pasar))}}"    id="nilaiPasar" name="nilaiPasar" class="form-control">
                                   @if($errors->has('nilaiPasar'))
                                  <p style="color: red"> {{ $errors-> first('nilaiPasar')}}</p>
                                  @endif
                           </div>
                          <div class="form-group hidden">
                               <p>Nilai Taksasi</p>
                               <input readonly="" value="{{old('nilaiTaksasi',number_format($penjaminan->nilai_taksasi,0,'.',','))}}"    id="nilaiTaksasi" name="nilaiTaksasi" class="form-control">
                                   @if($errors->has('nilaiTaksasi'))
                                  <p style="color: red"> {{ $errors-> first('nilaiTaksasi')}}</p>
                                  @endif
                           </div>
                       
                          <div class="form-group">
                               <p>Taksiran Taksasi</p>
                               <input  onkeyup="FormatCurrency(this)"  value="{{old('taksiran_taksasi',number_format($penjaminan->taksiran_taksasi,0,'.',','))}}"    id="taksiran_taksasi" name="taksiran_taksasi" class="form-control">
                                   @if($errors->has('taksiran_taksasi'))
                                  <p style="color: red"> {{ $errors-> first('taksiran_taksasi')}}</p>
                                  @endif
                           </div>
                            <div class="form-group"> 
                                <p>Kapasitas Bayar<b style="color: red"> * </b></p> 
                                <div class="radio icheck-primary">
                                    <input  @if($penjaminan->kapasitas=="memenuhi") checked="" @endif    {{old('kapasitas')=='memenuhi' ? 'checked=""' : "" }}  id="memenuhi" class="radio" type="radio" name="kapasitas" value="memenuhi" /> 
                           ...
                           @endif
                            <div class="form-group">
                                <label>Analisis Staf</label>                            
                                <textarea required="" style="resize:true;height:120px;" value="" name="hasilakhir" id="hasilakhir" class="form-control">{{old('hasilakhir',$penjaminan->hasil_akhir)}}</textarea>
                             ...
                             <div class="form-group">
                                ...
                                <textarea readonly=""  required="" style="resize:true;height:120px;" value="" name="rekomendasiKabag" id="rekomendasiKabag" class="form-control">{{old('rekomendasiKabag',$penjaminan->rekomendasi_kabag)}}</textarea>
                                @if($errors->has('rekomendasiKabag'))
                                <p style="color: red"> {{ $errors-> first('rekomendasiKabag')}}</p>
                                @endif
                            </div> 
                                 @endif
                                  @if($penjaminan->statusbayar==1 && $penjaminan->case=='Ya')
                                        <div class="form-group">
                                                <p><b>Catatan Pembayaran</b></p>
                                                <textarea style="resize:none;width:100%;height:100px;"  name="catatanPembayaran" id="catatanPembayaran" class="form-control">{{old('catatanPembayaran',$penjaminan->catatan_pembayaran)}}</textarea>  
