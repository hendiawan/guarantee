                ...
                <div style="margin:10px" class="panel-body">
                   ...
                   <p><b>Lampiran File</b></p>
                        ...
                        <div class="form-group">
                              ...
                              <textarea style="resize:none;width:100%;height:100px;"  name="analisa" id="analisa" class="form-control">{{$penjaminan->analisa_pekerjaan}}</textarea>  
                        ...
                        <div class="form-group">
                              <p>Analisa Umur dan Fasilitas Kredit<b style="color: red"> * </b></p> 
                               <textarea style="resize:none;width:100%;height:100px;"  name="analisaUmur" id="analisaUmur" class="form-control">{{$penjaminan->analisa_umur}}</textarea>  
                        ...
                        <div class="form-group">
                               ...
                               <p>Tekanan Darah</p>
                               <input value="{{old('TekananDarah',$penjaminan->tensi)}}"  id="TekananDarah" name="TekananDarah" class="form-control"> 
                                  @if($errors->has('TekananDarah'))
                                  <p style="color: red"> {{ $errors-> first('TekananDarah')}}</p>
                                  @endif
                                <p>Gula Darah</p>
                                <input value="{{old('GulaDarah',$penjaminan->guladarah)}}"  id="GulaDarah" name="GulaDarah" class="form-control">
                                   @if($errors->has('GulaDarah'))
                                  <p style="color: red"> {{ $errors-> first('GulaDarah')}}</p>
                                  @endif
                                 <p>Kolesterol</p>
                                 <input  value="{{old('Kolesterol',$penjaminan->kolesterol)}}"  id="Kolesterol" name="Kolesterol" class="form-control">
                                 @if($errors->has('Kolesterol'))
                                  <p style="color: red"> {{ $errors-> first('Kolesterol')}}</p>
                                  @endif
                                 <p>Tekanan Jantung</p>
                                 <input value="{{old('Tekananjantung',$penjaminan->tekanan_jantung)}}"    id="Tekananjantung" name="Tekananjantung" class="form-control">
                        ...
                        <div class="form-group">
                                <p><b>DATA KESEHATAN</b></p>
                                <textarea style="resize:none;width:100%;height:100px;"  name="analisaKesehatan" id="analisaKesehatan" class="form-control">{{old('analisaKesehatan',$penjaminan->analisa_kesehatan)}}</textarea>  
                           ...
                           @endif
                            <div class="form-group">
                                <label>Analisa Akhir dan Rekomendasi</label>                            
